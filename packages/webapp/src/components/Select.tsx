    ...
    <Root value={value} disabled={loading || disabled} onValueChange={handleChange}>
      ...
      <Portal>
        <Content
          ...
          {...contentProps}
          className={cn(
            'dark:bg-slate-900 dark:ring-white/10 isolate z-10 max-h-[18.5rem] rounded-xl border-2 border-white/80 bg-white/20 p-1 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.4)] outline outline-1 outline-transparent ring-1 backdrop-blur-3xl focus:outline-none dark:shadow-lg dark:ring-1',
    ...
    <Popover.Root open={open} onOpenChange={handleOpenChange}>
      ...
      <Popover.Portal>
        <Popover.Content
          ...
          {...contentProps}
          className={cn(
            'dark:bg-slate-900 dark:ring-white/10 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-90 data-[state=open]:zoom-in-90 isolate z-10 max-h-[22rem] origin-top-left rounded-xl border-2 border-white/80 bg-white/20 p-1 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.4)] outline outline-1 outline-transparent ring-1 backdrop-blur-3xl focus:outline-none sm:max-h-[20rem] dark:shadow-lg dark:ring-1',
            contentProps?.className
          )}
          data-slot="content"
