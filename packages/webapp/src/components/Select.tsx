    ...
    <Root value={value} disabled={loading || disabled} onValueChange={handleChange}>
      ...
      <Portal>
        <Content
          ...
          {...contentProps}
          className={cn(
            'dark:bg-foreground dark:ring-accent-light isolate z-10 max-h-[18.5rem] rounded-xl border-2 border-white/80 bg-white/20 p-1 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.4)] outline outline-1 outline-transparent ring-1 backdrop-blur-3xl focus:outline-none dark:shadow-lg dark:ring-1',
